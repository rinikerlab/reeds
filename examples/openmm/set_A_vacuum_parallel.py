...
The number of MPI processes needs to be euqal to the number of replicas, so the script should be called as 'mpiexec -np 16 python set_A_vacuum_parallel.py'
"""
