...
int
    ...
    add_replicas_mode = add_replicas
    cur_svals = num_svals
    ...
    for iteration in range(1, soptIterations + 1):
        ...
        if (add_replicas_mode == -1):  # doubleing case
            add_replicas = cur_svals - ligands.number

        # note: current_num_svals is the number of svalues used for the analysis, i.e. the
        # number of svalues *before* the optimization
        soptimization_options = soptimization_params(add_replicas=add_replicas,
                                                     adding_new_sReplicas_Scheme=adding_new_sReplicas_Scheme,
        ...
        cur_svals = cur_svals + add_replicas
