...
active_qualitative_map_mligs = lambda num_ligs: plt.cm.turbo(np.linspace(0,1,num_ligs))
active_qualitative_cycler_mligs = lambda num_ligs: cycler('color', plt.cm.turbo(np.linspace(0,1,num_ligs)))
